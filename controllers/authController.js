...
const signup = catchAsync(async (req, res, next) => {
    ...
    //create a token with following properties
...
const login = catchAsync(async (req, res, next) => {
    ...
    //check if user is exixts & password is correct 
    ...
    //if everything is correct then send token to client
    createSendToken(user, 200, res)
})

const protects = catchAsync(async (req, res, next) => {
...
const forgotPassword = catchAsync(async (req, res, next) => {
    // 1) GET user based on provided(stored) email
